...
last_updated: 同步"工具调用解析与截断处置移入工具层"条目为 v2.0（provider 尽力解析，原"RawToolCall 原样契约"表述已不准确）
...
| 2026-09-10 | 工具调用解析与截断处置移入工具层 v2.0（provider 尽力解析 str\|dict + 工具层信任边界回喂 + finish 链路承载截断强调） | decided | agent | [详情](.\2026-09-10-工具调用解析与截断处置移入工具层.md) |
